            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="selectpicker show-tick show-menu-arrow form-control province" name="data[province_id]">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="selectpicker show-tick show-menu-arrow form-control district" name="data[district_id]">
