                    ...
                    <div class="col-lg-7 col-md-6 col-xs-12 mb-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12 mb-15">
                                ...
                                <select class="selectpicker show-tick show-menu-arrow province form-control" name="province_id">
                            ...
                            <div class="col-sm-6 col-xs-12 mb-15">
                                ...
                                <select class="selectpicker show-tick show-menu-arrow district form-control" name="district_id">
