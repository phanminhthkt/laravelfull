...
<li>
    <a href="<?php echo e(route('admin.supplier.index', ['type'=>$type])); ?>"> <?php echo e($pageTitle); ?> </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.supplier.store',['type'=>$type])); ?>">
